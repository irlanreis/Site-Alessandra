import '../style/Session09.css'

const Session09Footer = () => {
  return (
    <div>
      <footer className="container-09">
        <h1 className="title-09">Alessandra</h1>
        <button className="button-09">Comprar agora</button>
        <button className="button-09">Home</button>
        <button className="button-09">Sobre</button>
      </footer>
...
export default Session09Footer;